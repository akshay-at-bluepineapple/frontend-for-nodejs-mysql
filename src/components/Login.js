...
function Login() {
  ...
  const passwordChangeHandler = (event) => {
    // console.log(event.target.value);
    event.target.value <= 0 ? setPassValidator(false) : setPassValidator(true);
              ...
              <div className="mt-6 space-y-2">
                <div>
                  ...
                  <input
                    ...
                    name="email"
                    id="email"
                    className={`block w-full px-5 py-3 text-base text-neutral-600 placeholder-gray-300 transition duration-500 ease-in-out transform border ${
                      emailvalidator === true
                        ? "border-transparent"
                        : "border-red-600"
                    } rounded-lg bg-gray-50 focus:outline-none focus:border-transparent focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-300`}
                ...
                <div className="flex flex-col mt-4 lg:space-y-2">
                  <button
                    type="button"
                    className={`${
                      emailvalidator === false || passvalidator === false
                        ? "hidden"
                        : ""
